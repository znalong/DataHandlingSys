...
namespace DataHandlingSys
{
    ...
    public static class Encoder
    {
        ...
        /// <returns>位图</returns>
        public static Bitmap code(string msg, int version, int pixel, int icon_size, int icon_border, bool white_edge)
        {
            ...
            Bitmap icon = new Bitmap(icon_size, icon_size, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
            Bitmap bmp = code.GetGraphic(pixel, Color.Black, Color.White, icon, icon_size, icon_border, white_edge);
